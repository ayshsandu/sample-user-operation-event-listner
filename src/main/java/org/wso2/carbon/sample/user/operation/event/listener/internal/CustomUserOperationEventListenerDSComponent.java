...
import org.wso2.carbon.sample.user.operation.event.listener.CustomIdentityMgtConfig;
...
public class CustomUserOperationEventListenerDSComponent {
    ...
    private static void init() {
        CustomIdentityMgtConfig.getInstance(DataHolder.getInstance().getRealmService().getBootstrapRealmConfiguration
                ());
    }
